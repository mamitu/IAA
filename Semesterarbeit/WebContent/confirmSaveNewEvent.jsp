...
<s:form>
	<s:submit action="ConfirmSaveNewEvent" key="button.save.name"/>
	<s:submit action="CreateEvent" key="button.cancel.name"/>
	<table>
	...
	<s:hidden name="numberOfWeeklyRepetitions" />
</s:form>